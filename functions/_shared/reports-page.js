...
const imageUrl = (id) => `/api/reparaturberichte/bild/${encodeURIComponent(id)}?v=20260914-2`;
const image = (item, index) => {
  const src = imageUrl(item.id);
